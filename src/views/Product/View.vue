    ...
    <div id="wrapper" style="display: block">
        <div class="page-product-view" data-log="商品详情">
            ...
            <div class="header">
                <div class="left">
                    <a
                            onclick="_msq.push(['trackEvent', '8fb4bea51daee8a5-346f31c749f6e40d', '', 'pcpid']);
                            history.go(-1)" class="home"
                            data-stat-id="346f31c749f6e40d">
                        <img src="http://s1.mi.com/m/images/m/icon_back_n.png" class="ib">
                    </a><!--vue-if--><!--vue-if-->
                </div>
                <div class="tit"><!--vue-if-->
                </div><div class="right">
                <a href="javascript:;"
                   data-event="30000000110001001"
            ...
            <div   class="product-view">
                ...
                <div class="ui-b7">
                    ...
                    <div class="ui-carousel-container">
                        <div class="ui-carousel-viewport">
                            <router-link :to="{name:'view',params:{id:recommend.id}}" v-for="recommend in recommends" :key="recommend.id">
                ...
                <div class="b5" v-html="product.markdown_html_code">
                    <div class="b51"></div>
                    <div class="b52">
                        <div class="blc">
                            <ul>
    ...
    export default {
        ...
        methods:{
            init(){
                ...
                this.axios.get(`api/product/view?id=${id}`).then(res=>{
            ...
            buy(){
                ...
                this.axios.post(`api/cart`,{product_id:id}).then(res=>{
                    this.$router.push({name: "cart_shop"})
                })
