        ...
        <div class="edit-box">
            <ul class="ui-list">
                ...
                <li class="ui-list-item">
                    ...
                    <div class="ui-input" @click="address">
                        <input placeholder="省 市 区" name="pcd" maxlength="20" type="text" readonly="readonly" v-model="pca">
                    </div>
                </li>
                <li class="ui-list-item">
            ...
            <div class="save-button">
                <a href="javascript:;" class="ui-button" @click="init"><span>保存地址</span></a>
            </div>
        </div>
        ...
        <div class="ui-pop" :style="isShow">
            <div class="ui-pop-content">
                <div class="region-list">
                    <v-distpicker type="mobile" @selected="haddle"></v-distpicker>
                </div>
            </div>
